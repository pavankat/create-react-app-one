...
* import, export vs export default 
* classes in es6 and how they relate to constructor functions

## jsx 

* make sure all of your content goes into a container component

* show how we use the BootstrapExample.js and cdn link in public/index.html to use bootstrap

* show how to import an image and use it in jsx

* show how to import an image and use it in jsx

* show how to do comments in jsx

* show how to use props with jsx

* show how to make a prop required and restricted to a certain data type
